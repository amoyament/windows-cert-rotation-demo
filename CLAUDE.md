...
2. Auto-discover the AAP instance's AWS network configuration (VPC, subnet, security group) by looking up the EC2 instance behind `your-aap-url.example.com`
...
**Existing AAP Instance:** `http://your-aap-url.example.com`
...
```bash
export AAP_HOSTNAME="your-aap-url.example.com"
...
Open browser to `https://<WINDOWS_PUBLIC_IP>` and AAP UI at `http://your-aap-url.example.com` to watch it happen.
